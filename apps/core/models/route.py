...
class Route(models.Model):
    ...
    container_size = models.IntegerField(verbose_name="Tamaño del Contenedor", default=1000)
    ...
    fixed_freight_cost = models.IntegerField(verbose_name="Costo Fijo", default=0)
    ...
    custom_clearance_time = models.IntegerField(verbose_name="Tiempo de Despacho Aduanero", default=0)
    handling_time = models.IntegerField(verbose_name="Tiempo de Manejo de Puerto/Aeropuerto/Estación de Tren", default=0)
    extra_time = models.IntegerField(verbose_name="Tiempo Extra", default=0)
